...
# colours - taken from Solarised
bgcolor=002b36FF
ringcolor=073642FF
opaquebgcolor=103C48D8
wrongcolor=d33682FF
wrongbgcolor="$bgcolor"
inactivebgcolor=0A323DFF
inactivetextcolor=687D86FF
urgentbgcolor=32A19AFF
urgenttextcolor=0A323DFF
highlightcolor=2aa198FF
verifyingbgcolor="$bgcolor"
verifyingringcolor="$ringcolor"
backspacecolor=d33682FF
